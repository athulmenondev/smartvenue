        ...
        <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full bg-gray-900 border border-gray-600 rounded p-2 text-sm text-gray-300 focus:outline-none focus:border-blue-500" defaultValue="http://localhost:5000/api/" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-1">IoT Sensor Feed URL</label>
              <input type="text" className="w-full bg-gray-900 border border-gray-600 rounded p-2 text-sm text-gray-300 focus:outline-none focus:border-blue-500" defaultValue="wss://sensors.smartvenue.local/stream" />
            </div>
          </div>
        </div>
